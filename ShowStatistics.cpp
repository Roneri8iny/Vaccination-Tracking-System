...
ShowStatistics::ShowStatistics(unordered_map<string, User>& userMap, QStackedWidget& stackedWidget, QWidget* parent)
    : QMainWindow(parent)
{
    ui.setupUi(this);
    ...
    /* PercentageOf2ndDose = new QPushButton("Percentage Of 2nd Dose ", this);
     PercentageOf2ndDose->move(60, 150);
     PercentageOf2ndDose->setStyleSheet("color:royalblue;font:bold 17px;");
    ...
    //viewMalesPercentageTextEdit->move(235, 160);
    ...
    //viewFemalesPercentageTextEdit->move(240, 200);
